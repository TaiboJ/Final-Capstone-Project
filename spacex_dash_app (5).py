                                ...
                                # dcc.Dropdown(id='site-dropdown',...)
                                 dcc.Dropdown(id='site-dropdown',
                                                options=[
                                                    ...
                                                    {'label': 'CCFAS SLC-40', 'value': 'CCFAS SLC-40'},
                                                ],
                                                value='ALL',
...
def get_scatter_chart(entered_site):
    ...
    if entered_site == 'ALL':
            fig = px.scatter(spacex_df, x="Payload Mass (kg)", y="class", color="Booster Version Category", symbol="Booster Version Category")
            return fig
    else:
            filtered_df = spacex_df[spacex_df['Launch Site']==entered_site]
            # return the outcomes piechart for a selected site
